...
def group_profiles(profiles):
    ...
    for prof in profiles:
        key = (
            ...
            prof["unit"],
            prof.get("mode"),
            # An indicator and its probe are certified separately and stay separate. A
            # combined figure is the calibrating lab's to state, not this script's to
            # derive - where a certificate prints one, it is read from the certificate
