...
const certificateRoutes: FastifyPluginAsync = async (fastify) => {
    ...
    const certificate = await prisma.$transaction(async (tx: TransactionClient) => {
      ...
      const cert = await tx.certificate.create({
        data: {
          ...
          calibrationTenureUnit: body.calibrationTenureUnit || 'months',
          ...
          calibrationDueDateFormat: body.calibrationDueDateFormat || 'DD/MM/YYYY',
    ...
    const certificate = await prisma.$transaction(async (tx: any) => {
      const cert = await tx.certificate.update({
        ...
        data: {
          ...
          calibrationTenureUnit: calibrationTenureUnit || 'months',
          ...
          calibrationDueDateFormat: calibrationDueDateFormat || 'DD/MM/YYYY',
  ...
  fastify.get<{ Params: { id: string } }>('/:id/pdf-data', {
    ...
    return {
      ...
      calibrationTenureUnit: certificate.calibrationTenureUnit || 'months',
      ...
      calibrationDueDateFormat: certificate.calibrationDueDateFormat || 'DD/MM/YYYY',
