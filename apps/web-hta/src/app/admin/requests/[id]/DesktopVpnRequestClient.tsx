...
interface DesktopVpnRequestData {
  id: string
...
interface DesktopVpnRequestClientProps {
  request: DesktopVpnRequestData
}

export function DesktopVpnRequestClient({ request }: DesktopVpnRequestClientProps) {
    ...
    <div className="h-full overflow-auto bg-[#f1f5f9]">
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="p-2 rounded-[9px] bg-[#ecfdf5]">
            <Monitor className="size-5 text-[#065f46]" />
          </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 text-[13px] text-[#0f172a] border border-[#e2e8f0] rounded-[9px] placeholder:text-[#94a3b8] focus:ring-2 focus:ring-[#10b981]/20 focus:border-[#10b981] outline-none resize-none"
                  />
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={processing}
                    className="flex-1 inline-flex items-center justify-center gap-1.5 px-4 py-2.5 text-[12.5px] font-semibold text-white bg-[#059669] hover:bg-[#047857] rounded-[9px] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    {processing ? (
                      <Loader2 className="size-4 animate-spin" />
                    ) : (
                ...
                <p className="text-[10px] text-[#94a3b8] text-center">
                  Approving will generate a 7-day provisioning token for the engineer&apos;s desktop app.
                </p>
              </div>
            )}
          </div>
