      ...
      <div>
        ...
        <div className="relative">
          ...
          <Input
            ...
            disabled={disabled}
            className="w-full rounded-xl border border-slate-300 bg-white h-9 text-xs pl-10 pr-10 focus:ring-2 focus:ring-primary focus:border-primary shadow-sm"
          />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Input
            ...
            disabled={disabled}
            className="w-full rounded-xl border border-slate-300 bg-white h-9 text-xs px-3 focus:ring-2 focus:ring-primary focus:border-primary shadow-sm"
          />
        </div>
      </div>
