    ...
    <div className="bg-section-inner rounded-xl p-5 border border-slate-300 mt-5">
      ...
      <div className="bg-white rounded-xl p-4 border border-slate-200">
        ...
        {/* Steps 3 and 4 - how it was used, and what that gives.
            The requirement, the comparison and the SOP sit inside the declaration
            panel: they are what the declaration produced, and reading them as
            separate sections below it loses that they answer the same question. */}
